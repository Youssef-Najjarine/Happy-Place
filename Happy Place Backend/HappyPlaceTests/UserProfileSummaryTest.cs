...
public class UserProfileSummaryTest {
    ...
    public void ValidTokenForEmailUserReturnsOk() {
        ...
        testingMockProvidersContainer.WebClient.PostJson("api/authentication/signUpWithEmail", signUpData).EnsureSuccessStatusCode();
        ...
        HttpResponseMessage profileResponse = testingMockProvidersContainer.WebClient.PostJson("api/authentication/validateToken", new { AuthToken = authToken });
    ...
    public void ValidTokenForPhoneUserReturnsOk() {
        ...
        testingMockProvidersContainer.WebClient.PostJson("api/authentication/signUpWithPhone", signUpData).EnsureSuccessStatusCode();
    ...
    public void AvatarColorIsConsistentAcrossMultipleCalls() {
        ...
        HttpResponseMessage firstProfileResponse = testingMockProvidersContainer.WebClient.PostJson("api/authentication/validateToken", new { AuthToken = authToken });
        string firstColor = firstProfileResponse.ReadContentAsJsonDocument().RootElement.GetProperty("avatarColor").GetString();

        HttpResponseMessage secondProfileResponse = testingMockProvidersContainer.WebClient.PostJson("api/authentication/validateToken", new { AuthToken = authToken });
    ...
    public void EmptyTokenReturnsUnauthorized() {
        ...
        HttpResponseMessage response = testingMockProvidersContainer.WebClient.PostJson("api/authentication/validateToken", new { AuthToken = "" });
    ...
    public void InvalidTokenReturnsUnauthorized() {
        ...
        HttpResponseMessage response = testingMockProvidersContainer.WebClient.PostJson("api/authentication/validateToken", new { AuthToken = "not-a-real-token-at-all" });
    ...
    public void TamperedTokenReturnsUnauthorized() {
        ...
        HttpResponseMessage response = testingMockProvidersContainer.WebClient.PostJson("api/authentication/validateToken", new { AuthToken = tamperedToken });
    ...
    public void MissingTokenFieldReturnsUnauthorized() {
        ...
        HttpResponseMessage response = testingMockProvidersContainer.WebClient.PostJson("api/authentication/validateToken", new { });
    ...
    public void TwoUsersReceiveTheirOwnProfileData() {
        ...
        testingMockProvidersContainer.WebClient.PostJson("api/authentication/signUpWithEmail", new { Name = name1, Email = uniqueEmail1, Password = "Seven74!" }).EnsureSuccessStatusCode();
        ...
        HttpResponseMessage verify1 = testingMockProvidersContainer.WebClient.PostJson("api/authentication/verifyEmail", new { Email = uniqueEmail1, VerificationCode = code1 });
        string token1 = verify1.ReadContentAsJsonDocument().RootElement.GetProperty("authToken").GetString();

        testingMockProvidersContainer.WebClient.PostJson("api/authentication/signUpWithEmail", new { Name = name2, Email = uniqueEmail2, Password = "Seven74!" }).EnsureSuccessStatusCode();
        ...
        HttpResponseMessage verify2 = testingMockProvidersContainer.WebClient.PostJson("api/authentication/verifyEmail", new { Email = uniqueEmail2, VerificationCode = code2 });
        string token2 = verify2.ReadContentAsJsonDocument().RootElement.GetProperty("authToken").GetString();

        HttpResponseMessage profile1 = testingMockProvidersContainer.WebClient.PostJson("api/authentication/validateToken", new { AuthToken = token1 });
        HttpResponseMessage profile2 = testingMockProvidersContainer.WebClient.PostJson("api/authentication/validateToken", new { AuthToken = token2 });
