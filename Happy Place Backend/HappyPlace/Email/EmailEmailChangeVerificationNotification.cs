...
public class EmailEmailChangeVerificationNotification {
    // Fields
    ...
    public static void Send(String toAddress, String name, String verificationCode) {
        ...
        message.Subject = "Happy Place Email Change Verification Code";
        message.SetHtmlBody($@"
<!DOCTYPE html>
<html>
<head>
...
<body style='font-family: Arial, sans-serif; line-height: 1.6; color: rgba(35, 35, 35, 1.0); max-width: 600px; margin: 0 auto; padding: 20px;'>
    <div style='background-color: #F9F9F9; padding: 20px; border-radius: 8px;'>
        <h1 style='color: #ED5370; text-align: center; font-size: 24px; margin-bottom: 10px;'>Confirm Your New Email</h1>
        <p style='font-size: 16px; margin-bottom: 20px;'>Hi <strong>{name}</strong>,</p>
        <p style='font-size: 16px; margin-bottom: 30px;'>You requested to change your Happy Place email address to this one. Use the 6-digit code below to confirm the change:</p>
        ...
        <p style='font-size: 14px; color: rgba(35, 35, 35, 0.50); margin-top: 20px;'>This code will expire in 10 minutes. If you didn't request this change, please ignore this email and your account will remain unchanged.</p>
